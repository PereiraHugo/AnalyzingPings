...
namespace AnalyzingPings
{
    public partial class MainWindow : Form
    {
        ...
        /// <summary>
        /// Method to initialize the graphic main window of the programm.
        ...
        /// The first action is to disenable the start button.
        /// Then get from the list the country selected. If random choosed, it compute the random.
        /// With the abreviation of the country it complete the url_to_open.
        ...
        /// The verticale line is situated with a position index of the vector
        /// </summary>
        ...
        /// Enable the rest of the programm if the computer is connected to the internet.
        /// </summary>
